...
## Project Structure
    ...
    ├── testapiautoconnecto_66951  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_66951`
...
2. Clone this repo and `cd testapiautoconnecto_66951`
